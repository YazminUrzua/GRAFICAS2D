...
public class perspective extends JFrame {
    ...
    public void drawCube(int size, double[] projectionVector) {
        ...
        // Ajustar el vector de proyección para reducir el tamaño
        double scale = 0.2; // Puedes ajustar este valor según sea necesario
        double[] scaledProjectionVector = {
            projectionVector[0] * scale,
            projectionVector[1] * scale,
            projectionVector[2] * scale
        };
        ...
        for (int[] point : cubePoints) {
            ...
            double zp = scaledProjectionVector[2];
            double xp = scaledProjectionVector[0];
            double yp = scaledProjectionVector[1];
    ...
    public static void main(String[] args) {
        perspective app = new perspective();
        app.setVisible(true);
